        ...
        <>
            <div className="pb-10 lg:pb-10">
                ...
                <div className="relative">
                    <iframe title="Próximo Diplomado" scrolling="no" style={{ background: "transparent", colorScheme: "normal", color: "white" }} className="w-full h-48 lg:h-40" allowtransparency="true" src={URLiframe} />
                    <div className="pt-0">
