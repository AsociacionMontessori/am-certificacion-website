        ...
        <>
            <div className="pb-10 lg:pb-0">
                ...
                <div className="relative">
                    <iframe title="Próximo Diplomado" scrolling="no" style={{ background: "transparent", colorScheme: "normal", color: "white" }} className="w-full h-24" allowtransparency="true" src={URLiframe} />
                    <div className="pt-0">
                        ...
                        <a href='../diplomados' className="mt-3 sm:mt-0 btn btn-outline hover:text-white hover:bg-green bg-gradient-to-r from-green/50 hover:from-gray hover:bg-opacity-70 rounded-full px-10 mr-4 bg-green text-white bg-opacity-10 w-full md:w-auto">
                            Conoce el Diplomado
