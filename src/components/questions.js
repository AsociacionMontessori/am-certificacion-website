...
const Questions = () => {
    ...
    return (
        <div className="bg-white w-10/12 md:w-8/12 m-10 rounded-tl-3xl rounded-br-3xl text-black">
            <div className="sm:p-10 p-2">
                <div className="md:p-5 p-2">
                    <h2 className="md:text-4xl lg:text-6xl text-xl font-medium">Preguntas Frecuentes</h2>
                </div>
                <div className="md:p-5 p-2">
                    {preguntasRespuestas.map((item, index) => (
                        <div key={index}>
                            ...
                            {respuestasVisibles[index] && (
                                <p className="md:text-base text-xs m-1 my-2 md:m-4">{item.respuesta}</p>
                            )}
                        </div>
                    ))}
                </div>
