...
const navigation = [
  ...
  {
    key: "nav.escuelaParaNinos",
    href: "https://kalpilli.com/",
    current: false,
    external: true,
  },
...
export default function Nav({ textColor }) {
  ...
  const itemHref = item =>
    item.external ? item.href : localizedPath(item.path)
              ...
              <div className="flex flex-1 items-center justify-center lg:items-stretch lg:justify-between px-7">
                <div className="flex flex-shrink-0 items-center lg:px-6 md:px-4">
                  <a href={localizedPath("/")}>
                    <StaticImage
                      className="mx-auto h-12 w-[51px] sm:h-10 sm:w-[43px] lg:h-20 lg:w-[85px]"
                      src="../images/lasc.png"
                      alt={t("nav.logoAlt")}
                      width={85}
                      ...
                      >
                        ...
                        <div className="inline relative opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out transistion-all">
                          <StaticImage
                            ...
                            src="../images/elements/decor2.png"
                            alt="decoration"
                          />
                        </div>
                      </a>
