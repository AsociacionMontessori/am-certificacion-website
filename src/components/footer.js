  ...
  return (
    <footer className="bg-gray-700 text-white pb-8 flex flex-col justify-center items-center max-w-full">
      <div className=" pl-0 lg:pl-20 xl:pl-10 2xl:pl-0 py-4 px-1 flex flex-col md:flex-row justify-start items-center w-full">
        <a
          href="#home"
          className="flex mx-6 justify-center p-1.5 lg:p-4 items-center lg:w-4/12 md:w-9/12"
        >
          <StaticImage
            src="../images/lasc.png"
      ...
      <div className="bg-gray-700 mt-8 text-xs">
        <div className="mx-1 grid grid-cols-1 gap-1 px-1 sm:py-0 md:mx-10 md:grid-cols-4 md:gap-0 md:px-6 md:py-2 lg:py-4 [&_a]:flex [&_a]:min-h-[24px] [&_a]:items-center [&_button]:min-h-[24px]">
          <div className="lg:pl-16 pl-0 text-center md:text-left m-4 md:m-0">
            ...
            <a
              target="_blank"
              className="hover:underline decoration-red"
              href={`${localizedPath(
                "/diplomados/"
            ...
            <a
              target="_blank"
              className="hover:underline decoration-red"
              href={`${localizedPath("/")}#sobrenosotros`}
            >
            ...
            <a
              target="_blank"
              className="hover:underline decoration-red"
              href={localizedPath("/publicaciones/")}
            >
            ...
            <a
              target="_blank"
              className="hover:underline decoration-red"
              href={`${localizedPath("/contact/")}#Preguntas Frecuentes`}
            >
          ...
          <div className="text-center md:text-left m-4 md:m-0">
            ...
            >
              {t("legal.avisoPrivacidad")}
            </a>
            <br />
            <a
              className="hover:underline decoration-red"
              href={localizedPath("/reembolsos/")}
              target="_blank"
              rel="noopener noreferrer"
            >
              {t("legal.politicaReembolsos")}
            </a>
            <br />
            <a
              className="hover:underline decoration-red"
              href="https://drive.google.com/file/d/1XaVbYjwltjMJjcjvCuqdhKIAFvxjecOJ/view"
              target="_blank"
              rel="noopener noreferrer"
            >
              {t("legal.constanciaSeguridad")}
            </a>
            <br />
            <a
              className="hover:underline decoration-red"
              href="https://drive.google.com/file/d/1mE54tJUcoFfaX4mJQjaD7slE_ESlPY-r/view"
              target="_blank"
              rel="noopener noreferrer"
            >
              {t("legal.vistoBuenoSeguridad")}
            </a>
            <br />
            <button
              type="button"
          ...
          <div className="text-center md:text-left m-4 md:m-0">
            ...
            <a
              className="hover:underline decoration-red italic"
              href="https://www.google.com.mx/maps/place/Primaria+Montessori+Kalpilli/@19.3925921,-99.1847762,17z/data=!4m6!3m5!1s0x85d1ff7b7998ce53:0x3f544be41b8ca559!8m2!3d19.3928452!4d-99.1838964!16s%2Fg%2F11sj5sp5xh?entry=ttu"
              target="_blank"
              rel="noopener noreferrer"
            >
              {t("escuelas.kalpilli")}
            </a>{" "}
            {t("escuelas.verEnMapa")}
            <br />
            <a
              href="mailto:admin@certificacionmontessori.com"
              target="_blank"
              rel="noopener noreferrer"
            >
              {t("escuelas.email")}
            ...
            <br />
            <a href="tel:5555152701" target="_blank" rel="noopener noreferrer">
              {t("escuelas.telefono")}
            </a>
            <br />
            <TrackedActionLink
            ...
            <br />
            <a
              className="hover:underline decoration-red w-1/4"
              href="https://www.google.com.mx/maps/place/Primaria+Montessori+Kalpilli/@19.3925921,-99.1847762,17z/data=!4m6!3m5!1s0x85d1ff7b7998ce53:0x3f544be41b8ca559!8m2!3d19.3928452!4d-99.1838964!16s%2Fg%2F11sj5sp5xh?entry=ttu"
              target="_blank"
              rel="noopener noreferrer"
            >
              {t("escuelas.direccion")}
            </a>
          </div>
            ...
            <div className="flex items-center">
              ...
              >
                <StaticImage
                  ...
                  alt={t("redes.instagramAlt")}
                />
              </a>
              <a
                href="https://www.linkedin.com/in/asociaci%C3%B3n-montessori-de-m%C3%A9xico-a-c-5a868417a/?originalSubdomain=mx"
                target="_blank"
                rel="noopener noreferrer"
              >
                <StaticImage
                  src="../images/linkedin.png"
                  alt={t("redes.linkedinAlt")}
                  className="w-6 h-6 mr-8   md:mr-0 lg:mr-2"
                />
              </a>
              <a
                href="https://www.youtube.com/@montessorimx"
                target="_blank"
                rel="noopener noreferrer"
              >
                <StaticImage
                  src="../images/youtube.png"
                  alt={t("redes.youtubeAlt")}
                  className="w-6 h-6 mr-8   md:mr-0 lg:mr-2"
                />
              </a>
              <a
              ...
              >
                <StaticImage
                  ...
                  alt={t("redes.facebookAlt")}
                  className="w-6 h-6 mr-8   md:mr-0 lg:mr-2"
                />
              </a>
              <a
                href="https://www.tiktok.com/@montessorimx"
                target="_blank"
                rel="noopener noreferrer"
              >
                <StaticImage
                  src="../images/tik-tok.png"
                  alt={t("redes.tiktokAlt")}
                  className="w-6 h-6 "
                />
              </a>
            </div>
