        ...
        <div className="overflow-hidden mt-5">
          <section className="my-5 block h-12 overflow-hidden relative w-max marquee-left xxl:hidden">
            <div className="flex float-left w-50">
              <label class="bg-red/20 dark:bg-black hover:font-semibold dark:hover:text-blue rounded-full py-3 px-10 dark:text-white/80 mx-3">El niño crea sus propios movimientos y, una vez creados, los perfecciona</label>
              <label class="bg-red/20 dark:bg-black hover:font-semibold dark:hover:text-blue rounded-full py-3 px-10 dark:text-white/80 mx-3">No se puede ser libre, si no se es independiente</label>
              <label class="bg-red/20 dark:bg-black hover:font-semibold dark:hover:text-blue rounded-full py-3 px-10 dark:text-white/80 mx-3">Lo que la mano hace, la mente lo recuerda</label>
              <label class="bg-red/20 dark:bg-black hover:font-semibold dark:hover:text-blue rounded-full py-3 px-10 dark:text-white/80 mx-3">El niño crea sus propios movimientos y, una vez creados, los perfecciona</label>
              <label class="bg-red/20 dark:bg-black hover:font-semibold dark:hover:text-blue rounded-full py-3 px-10 dark:text-white/80 mx-3">No se puede ser libre, si no se es independiente</label>
              <label class="bg-red/20 dark:bg-black hover:font-semibold dark:hover:text-blue rounded-full py-3 px-10 dark:text-white/80 mx-3">Lo que la mano hace, la mente lo recuerda</label>
              <label class="bg-red/20 dark:bg-black hover:font-semibold dark:hover:text-blue rounded-full py-3 px-10 dark:text-white/80 mx-3">El niño crea sus propios movimientos y, una vez creados, los perfecciona</label>
          ...
          <section className="my-5 block h-12 overflow-hidden relative w-max marquee-left xxl:hidden">
            <div className="flex float-left w-50">
              <label class="bg-red/20 dark:bg-black hover:font-semibold dark:hover:text-green/70 rounded-full py-3 px-10 dark:text-white/80 mx-3">No se puede ser libre, si no se es independiente</label>
              <label class="bg-red/20 dark:bg-black hover:font-semibold dark:hover:text-green/70 rounded-full py-3 px-10 dark:text-white/80 mx-3">Lo que la mano hace, la mente lo recuerda</label>
              <label class="bg-red/20 dark:bg-black hover:font-semibold dark:hover:text-green/70 rounded-full py-3 px-10 dark:text-white/80 mx-3">El niño crea sus propios movimientos y, una vez creados, los perfecciona</label>
              <label class="bg-red/20 dark:bg-black hover:font-semibold dark:hover:text-green/70 rounded-full py-3 px-10 dark:text-white/80 mx-3">No se puede ser libre, si no se es independiente</label>
              <label class="bg-red/20 dark:bg-black hover:font-semibold dark:hover:text-green/70 rounded-full py-3 px-10 dark:text-white/80 mx-3">Lo que la mano hace, la mente lo recuerda</label>
              <label class="bg-red/20 dark:bg-black hover:font-semibold dark:hover:text-green/70 rounded-full py-3 px-10 dark:text-white/80 mx-3">El niño crea sus propios movimientos y, una vez creados, los perfecciona</label>
              <label class="bg-red/20 dark:bg-black hover:font-semibold dark:hover:text-green/70 rounded-full py-3 px-10 dark:text-white/80 mx-3">No se puede ser libre, si no se es independiente</label>
