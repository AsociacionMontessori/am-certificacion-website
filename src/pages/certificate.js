    ...
    <Layout>
      ...
      <main className="overflow-x-hidden selection:text-white selection:bg-green selection:bg-opacity-20">
            ...
            <div>
              <div className="mr-auto md:w-3/5 md:pt-2 lg:w-2/3">
                ...
                <div className="relative">
                  <iframe style={{ background: "transparent", colorScheme: "normal", color: "white" }} className="w-full" allowTransparency src="https://montessorimexico.org/proxima-certificacion/" />
                  <div className="absolute top-16">
                    <a href="https://kalpilli.com/MetodoMontessori/" target="__blank" className="mt-3 sm:mt-0 btn btn-outline hover:text-white hover:bg-blue bg-gradient-to-r from-blue/50 hover:from-gray hover:bg-opacity-70 rounded-full px-10 mr-4 bg-blue text-white bg-opacity-10">
                      Inscríbete Ahora
                    </a>
                    <a href="https://kalpilli.com/MetodoMontessori/" target="__blank" className="mt-3 sm:mt-0 btn btn-outline hover:text-white hover:bg-green bg-gradient-to-r from-green/50 hover:from-gray hover:bg-opacity-70 rounded-full px-10 mr-4 bg-green text-white bg-opacity-10">
        ...
        <section id="" className="relative z-10 bg-gradient-to-r from-blue to-green pb-20">
          {/* <div className="mx-auto bg-gray pl-40">
            <h2 className="pb-10 pt-10">
              <span className="text-white text-2xl md:text-6xl font-bold">Próximos Cursos</span>
            </h2>
            <div className="relative">
              <iframe style={{ background: "transparent", colorScheme: "normal", color: "white" }} className="w-full" allowTransparency src="https://montessorimexico.org/proxima-certificacion/" />
              <a href="https://kalpilli.com/MetodoMontessori/" target="__blank" className="absolute top-16 sm:mt-0 btn btn-outline hover:text-white hover:bg-green bg-gradient-to-r from-green/50 hover:from-gray hover:bg-opacity-70 rounded-full px-10 mr-4 bg-green text-white bg-opacity-10">
                Conoce el Método
              </a>
            </div>
          </div> */}
