  ...
  return (
    <Layout>
      ...
      <main className="overflow-x-hidden">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-6 pb-40 pt-40 lg:px-12 xl:px-6 2xl:px-0">
            ...
            <div>
              <div className="mr-auto md:w-3/5 md:pt-2 lg:w-2/3">
                ...
                <div className="mb-5">
                  <a href="#certificacion_internacional" className="btn btn-outline hover:text-white hover:bg-blue bg-gradient-to-r from-blue/50 hover:from-gray hover:bg-opacity-70 rounded-full px-10 mr-4 bg-blue text-white bg-opacity-10">
        ...
        <section id="" className="relative py-5 z-10 bg-gradient-to-r from-blue to-green py-20">
          <CertificationPrice />
          <Scholarship />
        </section>
