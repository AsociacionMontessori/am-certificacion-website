...
const roxana = () => {
    ...
    return (
        <Layout>
            <main className="py-40 bg-gradient-to-r from-blue via-purple to-green pt-20 w-full  overflow-x-hidden">
                <section class="bg-gradient-to-r from-blue via-purple to-green">
                    <div class="container px-6 py-12 mx-auto">
                        <h1 class="px-6 mt-2 text-2xl font-bold text-gray-800 md:text-4xl dark:text-white">Directora de Asociación Montessori de México. </h1>
                        <div class="pt-10 max-w-4xl flex items-center h-auto flex-wrap mx-auto my-48 lg:my-0">
                            <div id="profile" class="w-full lg:w-2/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
                                <div class="p-4 md:p-12 text-center lg:text-left">
                                    ...
                                    ></div>
                                    <h1 class="text-3xl font-bold pt-8 lg:pt-0">Roxana Muñoz</h1>
                                    ...
                                    {/* <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
                                        ...
                                        Directora de Asociación Montessori de México.
                                    </p> */}
                                    ...
                                    <p class="pt-8 text-sm">
                                        lorep ipsum dolor sit amet, consectetur adipiscing elit. Aliquam at ipsum eu nunc commodo posuere et sit amet ligula.
                            ...
                            <div class="w-full lg:w-3/5">
                                <img src={img1} class="h-[32rem] rounded-none lg:rounded-lg shadow-2xl hidden lg:block" />
                            </div>
