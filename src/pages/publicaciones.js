                                    ...
                                    <div className="mt-5 mb-3 w-full">
                                        <ul className="flex flex-wrap text-xs font-medium -m-1">
                                            ...
                                            <li className="m-1 z-10 selection:text-white selection:bg-green selection:bg-opacity-20">
                                                <a title="Ver serie de libros en Amazon" className="inline-flex text-center text-gray-100 py-3 px-6 rounded-full bg-blue-500 hover:bg-blue-600 transition duration-150 ease-in-out" href="https://www.amazon.com.mx/dp/B0H13SC1QK" target="_blank" rel="noopener noreferrer">
                                                    Ver en Amazon
