                                ...
                                <div className="text-white ml-0 xl:-ml-40 -pt-28 lg:pt-10 w-full">
                                    ...
                                    <div class="mt-5 mb-3 w-full">
                                        <ul class="flex flex-wrap text-xs font-medium -m-1">
                                            <li class="m-1 z-10">
                                                <a class="inline-flex text-center text-gray-100 py-3 px-6 rounded-full bg-red hover:bg-opacity-90 transition duration-150 ease-in-out" href="#0">
                                                    Comprar Ahora
                                            ...
                                            <li class="m-1 z-10">
                                                <a class="inline-flex text-center text-gray-100 py-3 px-6 rounded-full bg-blue-500 hover:bg-blue-600 transition duration-150 ease-in-out" href="#0">
                                                    Ver en Amazon
