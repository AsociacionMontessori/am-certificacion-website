                                ...
                                <div className="text-white ml-0 xl:-ml-40 -pt-28 lg:pt-10 w-full">
                                    <header>
                                        <h3 class="text-2xl lg:text-4xl font-bold leading-tight mb-2">
                                            <h2 class="hover:text-gray-100 transition duration-150 ease-in-out">{title}</h2>
                                        </h3>
                                        <div>
                                    ...
                                    <div class="mt-5 mb-3 w-full">
                                        <ul class="flex flex-wrap text-xs font-medium -m-1">
                                            <li class="m-1 z-10">
                                                <a target="__blank" class="inline-flex text-center text-gray-100 py-3 px-6 rounded-full bg-red hover:bg-opacity-90 transition duration-150 ease-in-out" href="https://api.whatsapp.com/send?phone=5215548885013">
                                                    Comprar Ahora
                                            ...
                                            <li class="m-1 z-10">
                                                <a title="Ver serie de libro en Amazon" class="inline-flex text-center text-gray-100 py-3 px-6 rounded-full bg-blue-500 hover:bg-blue-600 transition duration-150 ease-in-out" href="https://www.amazon.com.mx/dp/B09VX943R1">
                                                    Ver en Amazon
