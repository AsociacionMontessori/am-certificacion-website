                                    ...
                                    <div className="mt-5 mb-3 w-full">
                                        <ul className="flex flex-wrap text-xs font-medium -m-1">
                                            <li className="m-1 z-10">
                                                <a target="__blank" className="inline-flex text-center text-gray-100 py-3 px-6 rounded-full bg-red hover:bg-opacity-90 transition duration-150 ease-in-out" href="https://api.whatsapp.com/send?phone=5215548885013&text=Hola,%20Me%20gustar%C3%ADa%20informaci%C3%B3n%20sobre%20la%20certificaci%C3%B3n%20Montessori.">
                                                    Comprar Ahora
                                            ...
                                            <li className="m-1 z-10 selection:text-white selection:bg-green selection:bg-opacity-20">
                                                <a title="Página de autor en Amazon" className="inline-flex text-center text-gray-100 py-3 px-6 rounded-full bg-blue-500 hover:bg-blue-600 transition duration-150 ease-in-out" href="https://www.amazon.com/author/montessori.mx" target="_blank" rel="noopener noreferrer">
