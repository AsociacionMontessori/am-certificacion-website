                        ...
                        <div className="container px-6 py-12 mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs md:text-lg text-left">
                                <div className="flex flex-col items-center justify-center text-center selection:text-white selection:bg-green selection:bg-opacity-20">
                                    ...
                                    <h2 className="mt-4 text-sm sm:font-medium text-gray-800 dark:text-white">Email</h2>
                                ...
                                <div className="flex flex-col items-center justify-center text-center selection:text-white selection:bg-green selection:bg-opacity-20">
                                    ...
                                    <h2 className="mt-4 text-sm sm:font-medium text-gray-800 dark:text-white">Encuéntranos en</h2>
                                    <p className="mt-2 ">Calle Av. Dos 48, San Pedro de los Pinos, Benito Juárez, 03800 Ciudad de México, CDMX</p>
                                </div>
                                {/* </div> */}

                                <div className="flex flex-col items-center justify-center text-center selection:text-white selection:bg-blue selection:bg-opacity-20">
                                    <span className="md:p-3 text-blue-500 rounded-full bg-blue-100/80 dark:bg-gray-800">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={iconsSize}>
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                                        </svg>
                                    </span>
                                    <h2 className="mt-4 text-sm sm:font-medium text-gray-800 dark:text-white">Contáctanos</h2>
