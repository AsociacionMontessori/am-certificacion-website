                ...
                <section class="bg-gradient-to-r from-blue via-purple to-green text-white">
                    <div class="container px-6 py-12 mx-auto">
                        <div class="">
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 text-xs md:text-lg text-left">
                                <div className="flex flex-col md:items-center md:justify-center md:text-center">
                                    ...
                                    <p className="mt-2">hello@montessori.com</p>
                                </div>
                    ...
                    <section className="bg-white h-[64rem] sm:h-[32rem]">
                        <div className="p-5 sm:mx-96">
                            <div className="grid grid-cols-1 sm:grid-cols-2 place-items-center">
                                ...
                                <div className="pt-40 sm:pt-0 h-80">
                                    <FacebookProvider appId="1019625052802455">
                                        <Page height={450} adaptContainerWidth smallHeader href="https://www.facebook.com/asociacionmontessori/" tabs="timeline" />
                                    </FacebookProvider>
                                </div>
                            </div>
