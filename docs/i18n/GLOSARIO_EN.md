...
3. Este archivo añade los términos propios del sitio (marketing, UI, instituciones).

Regla general: **consistencia con el canon AMI/Clio/Montessori-Pierson/NAMTA, no creatividad.** Todo prompt de traducción del sitio carga este archivo completo. Inglés **internacional** con ortografía **en-US** (criterio: la opción más portable, no la más estadounidense).

## 1. Registro del sitio web

El sitio es **marketing y divulgación** (familias, aspirantes a Guía, escuelas), NO texto doctrinal. Por la regla de función Casa dei Bambini / Children's House:

- Ambiente 3-6 en el sitio → **Children's House** (siempre, salvo referencia histórica a Roma 1907 → Casa dei Bambini sin glosa).
- Tono: profesional cálido, segunda persona («you»), frases directas de marketing. No calcar sintaxis española.
- Los aforismos/frases de María Montessori del marquee usan la versión canónica inglesa publicada (Clio/Montessori-Pierson) — ver `CITAS_PENDIENTES` del repo del diplomado; no re-traducir.

## 2. Términos críticos Montessori (heredados, no negociables)

| Español (sitio) | English | Prohibido |
|---|---|---|
| Guía Montessori / Guía (cap.) | **Montessori Guide** / **Guide** (cap.) | teacher, instructor, educator para el rol Montessori |
| ambiente preparado | **prepared environment** | learning environment, classroom |
| vida práctica | **Practical Life** (área curricular, cap.) | practical living, life skills |
| sensorial (área) | **Sensorial** | sensory |
| mente absorbente | **the absorbent mind** | sponge-like mind |
| período sensible | **sensitive period** | critical period |
| control de error | **control of error** | error control, self-correction |
| trabajo del niño | **the child's work** | play |
...
## 3. Nomenclatura del programa (dictamen diplomado 2026-07-08)

| Español (sitio) | English | Nota |
|---|---|---|
| Diplomado | **Diploma Course** | Nunca «diploma» a secas ni «degree» |
| Diplomado Guía Montessori | **Montessori Guide Diploma Course** | |
| Comunidad Infantil (0-3) / Nido | **Infant Community (0-3)** | «Nido» se conserva en italiano si aparece |
| Casa de Niños (3-6) | **Children's House (3-6)** | Regla de registro §1 |
| Taller (6-12) | **Elementary (6-12)** | Taller I/II → Elementary I/II |
| catedrático / profesor de materia | **course instructor** | |
| sesión / encuentro | **session** | |
| temario / programa analítico | **syllabus** | |
...
Precios: se muestran como están (`$4,900 MXN` / lógica USD existente); nunca convertir a mano en el texto.

## 6. Marco pedagógico AMMAC (7 dominios + Bloom)

Marco propio de AMMAC — traducción fiel, no canon externo (salvo términos §2 embebidos):

| Dominio ES | English |
|---|---|
| Fundamentos filosóficos e históricos | Philosophical and Historical Foundations |
| Desarrollo humano y planos del desarrollo | Human Development and the Planes of Development |
| El ambiente preparado y los materiales | The Prepared Environment and the Materials |
| Observación científica | Scientific Observation |
| Rol y transformación del adulto (Guía) | Role and Transformation of the Adult (the Guide) |
| Pedagogía de las áreas del currículo | Pedagogy of the Curriculum Areas |
| Comunidad, familia y liderazgo | Community, Family, and Leadership |
...
Igual que el glosario madre: el glosario manda sobre el texto; cambios por commit con prefijo `glosario:`; decisiones nuevas se registran aquí y, si son de alcance general, se proponen al glosario madre.
