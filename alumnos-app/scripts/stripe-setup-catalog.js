...
const CATALOG = [
  ...
  { sku: 'ebook_ammac_1', name: 'Ebook 1 - Pedagogía científica', amountMxn: 213, recurring: false },
  { sku: 'ebook_ammac_2', name: 'Ebook 2 - Secreto de la infancia', amountMxn: 213, recurring: false },
  { sku: 'ebook_ammac_3', name: 'Ebook 3 - Educación cósmica', amountMxn: 317, recurring: false },
  { sku: 'ebook_ammac_4', name: 'Ebook 4 - Guiones cósmicos', amountMxn: 317, recurring: false },
  { sku: 'ebook_pack_ammac_4', name: 'Paquete digital - 4 ebooks Roxana Muñoz', amountMxn: 839, recurring: false },
  { sku: 'ebook_pack_cosmica_2', name: 'Paquete Cósmico - Educación Cósmica + Guiones Cósmicos', amountMxn: 400, recurring: false },
...
const PARAM_NAMES = {
  ...
  ebook_ammac_1: 'STRIPE_PRICE_EBOOK_1',
  ebook_ammac_2: 'STRIPE_PRICE_EBOOK_2',
  ebook_ammac_3: 'STRIPE_PRICE_EBOOK_3',
  ebook_ammac_4: 'STRIPE_PRICE_EBOOK_4',
  ebook_pack_ammac_4: 'STRIPE_PRICE_EBOOK_PACK_4',
  ebook_pack_cosmica_2: 'STRIPE_PRICE_EBOOK_PACK_COSMICA',
